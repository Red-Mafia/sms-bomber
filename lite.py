...
# coding=utf-8
##########################################################
# AUTHOR : RED-MAFIA(RK)RIAZKHAN AND ALI RAZA #
...
# >_ TERMUX  #       NAMA KU RK AKU ADA RK         #
...
\033[0;35m   /  |/  /  _/ |/ /  _/   • CODE BY Red-Mafia(RK) •
...
def mmmasuk():
 ...
 #M,P))
	...
	print("%s [!] Isi dengan benar "%(O));exit()
        ...
        jeeck(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m  ================================================")
        jeeck(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m  (1 Komunitas termux Pakistan [ FACEBOOK ] ")
